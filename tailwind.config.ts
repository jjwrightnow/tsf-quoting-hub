  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        tsf: {
          blue: "hsl(var(--tsf-neon-blue))",
          pink: "hsl(var(--tsf-neon-pink))",
          surface: "hsl(var(--tsf-bg-surface))",
          panel: "hsl(var(--tsf-bg-panel))",
          "bubble-assistant": "hsl(var(--tsf-bubble-assistant))",
          "bubble-user": "hsl(var(--tsf-bubble-user))",
